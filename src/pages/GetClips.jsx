                        ...
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                            ...
                            <div className="w-full lg:w-auto pt-8 lg:pt-0">
                                <button
                                    ...
                                    className={`w-full lg:w-48 py-5 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-2xl shadow-xl hover:shadow-orange-500/40 transition-all transform hover:scale-105 active:scale-95 text-xl flex items-center justify-center gap-2 ${isProcessing ? 'opacity-75 cursor-wait' : ''}`}
                                >
                                    {isProcessing ? (
                                        <>
