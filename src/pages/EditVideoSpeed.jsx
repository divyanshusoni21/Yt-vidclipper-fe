                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    <button
                                        ...
                                        className="w-full py-4 bg-gray-900 text-white font-bold rounded-2xl shadow-lg hover:bg-gray-800 transform hover:scale-[1.02] transition-all disabled:opacity-75 disabled:cursor-wait flex flex-col items-center justify-center gap-1"
                                    >
                                        {isProcessing ? (
                                            <>
